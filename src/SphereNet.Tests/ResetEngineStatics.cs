...
public sealed class ResetEngineStaticsAttribute : BeforeAfterTestAttribute
{
    ...
    private static void Reset()
    {
        ...
        SphereNet.Game.Objects.Characters.Character.CanSeeSamePLevel = 0;
        SphereNet.Game.Objects.Characters.Character.StatsFlags = 0;
        SphereNet.Game.Objects.Characters.Character.ExperienceSystem = false;
        SphereNet.Game.Objects.Characters.Character.ExperienceMode = 0;
        SphereNet.Game.Objects.Characters.Character.ExperienceKoefPVP = 100;
        SphereNet.Game.Objects.Characters.Character.ExperienceKoefPVM = 100;
        SphereNet.Game.Objects.Characters.Character.LevelSystem = false;
        SphereNet.Game.Objects.Characters.Character.LevelNextAt = 0;
        SphereNet.Game.Objects.Characters.Character.LevelModeDouble = true;
        SphereNet.Game.Objects.Items.Item.AllowNewbTransfer = false;
        ...
        SphereNet.Game.Magic.SpellEngine.WopFont = 3;
        SphereNet.Game.Magic.SpellEngine.WopTalkMode = 10;
        SphereNet.Network.Packets.Outgoing.PacketContextMenu.EntryLimit = 15;
        SphereNet.Core.Types.Point3D.DistanceFormula = 0;
        SphereNet.Game.Movement.WalkCheck.MountHeight = false;
        SphereNet.Game.World.Sectors.Sector.MaxCharComplexity = 32;
        SphereNet.Game.World.Sectors.Sector.MaxSectorComplexity = 1024;
        SphereNet.Game.World.Sectors.Sector.ComplexityWarning = null;
        SphereNet.Game.Guild.GuildManager.DefaultMaxShips = 1;
        SphereNet.Scripting.Definitions.CharDef.DefaultEraLimitGear = 9;
        SphereNet.Scripting.Definitions.CharDef.DefaultEraLimitLoot = 9;
        SphereNet.Scripting.Definitions.CharDef.DefaultEraLimitProps = 9;
        SphereNet.Game.Clients.GameClient.DisplayElementalResistance = false;
        SphereNet.Game.Clients.GameClient.AllowBuySellAgent = false;
        SphereNet.Game.Clients.GameClient.TradeWindowSnooping = true;
        SphereNet.Game.Clients.GameClient.CharTags = false;
        SphereNet.Game.Clients.GameClient.VendorTradeTitle = true;
        SphereNet.Game.Clients.GameClient.VerboseItemBounce = false;
        SphereNet.Game.Clients.GameClient.GuestsMax = 0;
        SphereNet.Game.Clients.GameClient.AccountInUse = null;
        SphereNet.Game.Clients.GameClient.ArriveDepartMsg = 1;
        SphereNet.Game.Clients.GameClient.ServerName = "SphereNet";
