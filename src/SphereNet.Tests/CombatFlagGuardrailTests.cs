...
public class CombatFlagGuardrailTests
{
    ...
    private static readonly Dictionary<CombatFlags, string> BehaviorSite = new()
    {
        ...
        [CombatFlags.PreHit]             = "CombatHelper.GetDefaultSwingDelays (animation delay folded into recoil -> hit at swing start)",
        ...
        [CombatFlags.SwingNoRange]       = "CombatHelper.SwingIgnoresStartRange + EvaluateHitTime hold + @HitCheck Recoil_NoRange",
        [CombatFlags.AnimHitSmooth]      = "CombatHelper.GetDefaultSwingDelays / GetSwingAnimDelay / GetSwingHitDelayMs",
